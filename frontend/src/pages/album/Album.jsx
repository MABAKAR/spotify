   ...
   render() {
      return (
         <div>
            ...
            <button class="btn1 btn btn-primary" onClick={this.prevPage.bind(this)}>Prev</button>
            <button class="btn2 btn btn-primary"onClick={this.nextPage.bind(this)}>Next</button>
